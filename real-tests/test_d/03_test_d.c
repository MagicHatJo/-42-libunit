...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/18 21:20:13 by jochang           #+#    #+#             */
/*   Updated: 2019/05/18 21:20:13 by jochang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		test_d_03(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("Il fait au moins %d\n", -8000);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("Il fait au moins %d\n", -8000);
